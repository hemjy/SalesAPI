...
namespace SalesAPI.Infrastructure.Identity
{
    public class JwtTokenGenerator : IJwtTokenGenerator
    {
        ...
        public (string token, string refreshToken, DateTime refreshTokenExp) GenerateJwtTokenInfo(string userId, string username)
        {
